...
Report bugs at https://github.com/romnnn/stwberlin_menus/issues.
...
stwberlin menus could always use more documentation, whether as part of the
official stwberlin menus docs, in docstrings, or even on the web in blog posts,
articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to `file an issue <https://github.com/romnnn/stwberlin_menus/issues>`_ on GitHub.
...
Ready to contribute? Here's how to set up stwberlin_menus for local development.

1. Fork the `stwberlin_menus repo <https://github.com/romnnn/stwberlin_menus>`_ on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/stwberlin_menus.git
...
3. The pull request should work for python 3.5+. Check the
   `build status of your pull request <https://travis-ci.com/romnnn/stwberlin_menus/pull_requests>`_
...
.. _GitHub issues: https://github.com/romnnn/stwberlin_menus/issues
