...
setup(
    ...
    entry_points={
        "console_scripts": [
            "stwberlin_menus=stwberlin_menus.cli:main"
        ]
    },
    python_requires=">=3.6",
    ...
    package_data={"stwberlin_menus": []},
    keywords="stwberlin_menus",
    name="stwberlin_menus",
    packages=find_packages(include=["stwberlin_menus"]),
    test_suite="tests",
    url="https://github.com/romnnn/stwberlin_menus",
    version=version,
    zip_safe=False,
)
